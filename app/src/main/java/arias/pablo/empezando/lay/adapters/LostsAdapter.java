...
public class LostsAdapter  extends RecyclerView.Adapter<LostsAdapter.ViewHolder> {



    private ArrayList<Lost> datos;
    private Context context;

    public LostsAdapter(Context context) {
        datos = new ArrayList<Lost>();
    ...
    public void colocarDatos(ArrayList<Lost> datos) {
        this.datos = datos;
